...
public class HelloDozerConfig {
    ...
    @Bean
    public HelloDozerBeanMapping userStudentA2StudentBFieldMapping() {
        //配置要转换的bean, UserDto 和 UserDo 之间的字段转换
        HelloDozerBeanMapping smartBeanMapping = HelloDozerBeanMapping.create(StudentA.class, StudentB.class);
        ...
        //birthday 在两个类中是 同名的 但是类型不一样，参数是指定转换格式
        smartBeanMapping.fields("birthday", new StringDateConverter("yyyyMMdd"));
